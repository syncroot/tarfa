...
| **fast int4** (labeled) | **1.72 tok/s** (0.58 s/tok) | 21 s | 12.4 GB | int4 symmetric, per-row fp16 scale |

Exactness costs ~5× in speed, because exact mode streams **~19 GB of verified BF16 expert weights
